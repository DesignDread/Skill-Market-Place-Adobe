...
export default function ReportCard({ report }) {
  ...
  return <Link href={`/reports/${report.id}`} className="glass-panel group block rounded-2xl p-5 transition duration-300 hover:-translate-y-1 hover:border-primary/50 hover:shadow-[0_18px_50px_rgba(88,214,210,.08)]">
